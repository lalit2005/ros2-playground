...
#include "bot_interfaces/msg/detail/hardware_status__rosidl_typesupport_fastrtps_c.h"
...
using _HardwareStatus__ros_msg_type = bot_interfaces__msg__HardwareStatus;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = bot_interfaces__msg__HardwareStatus;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const bot_interfaces__msg__HardwareStatus * ros_message = static_cast<const bot_interfaces__msg__HardwareStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_bot_interfaces__msg__HardwareStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  bot_interfaces__msg__HardwareStatus * ros_message = static_cast<bot_interfaces__msg__HardwareStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_bot_interfaces__msg__HardwareStatus(cdr, ros_message);
}

static uint32_t _HardwareStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_bot_interfaces__msg__HardwareStatus(
...
static size_t _HardwareStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_bot_interfaces__msg__HardwareStatus(
