...
static const _ResetCounter_Request_type_support_symbol_names_t _ResetCounter_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bot_interfaces, srv, ResetCounter_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bot_interfaces, srv, ResetCounter_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bot_interfaces, srv, ResetCounter_Request)() {
  return &::bot_interfaces::srv::rosidl_typesupport_c::ResetCounter_Request_message_type_support_handle;
}
...
static const _ResetCounter_Response_type_support_symbol_names_t _ResetCounter_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bot_interfaces, srv, ResetCounter_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bot_interfaces, srv, ResetCounter_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bot_interfaces, srv, ResetCounter_Response)() {
  return &::bot_interfaces::srv::rosidl_typesupport_c::ResetCounter_Response_message_type_support_handle;
}
...
static const _ResetCounter_Event_type_support_symbol_names_t _ResetCounter_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bot_interfaces, srv, ResetCounter_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bot_interfaces, srv, ResetCounter_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bot_interfaces, srv, ResetCounter_Event)() {
  return &::bot_interfaces::srv::rosidl_typesupport_c::ResetCounter_Event_message_type_support_handle;
}
...
static const _ResetCounter_type_support_symbol_names_t _ResetCounter_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bot_interfaces, srv, ResetCounter)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bot_interfaces, srv, ResetCounter)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, bot_interfaces, srv, ResetCounter)() {
  return &::bot_interfaces::srv::rosidl_typesupport_c::ResetCounter_service_type_support_handle;
}
