...
#include "bot_interfaces/msg/detail/hardware_status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = bot_interfaces::msg::HardwareStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const bot_interfaces::msg::HardwareStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<bot_interfaces::msg::HardwareStatus *>(
    untyped_ros_message);
...
{
  return &bot_interfaces::msg::typesupport_fastrtps_cpp::_HardwareStatus__handle;
}
